...
public class XRUI_Helper
{
    ...
    public static void ConstraintVelocityLocally(Transform transformTarget, Rigidbody rigidbody, bool freezeX = true, bool freezeY = true, bool freezeZ = true)
    {
    ...
    public static void ConstraintPositionLocally(Transform transformTarget, Rigidbody rigidbody, bool freezeX = true, bool freezeY = true, bool freezeZ = true)
    {
        ...
        rigidbody.position = transformTarget.TransformPoint(localPosition);
    }
}
