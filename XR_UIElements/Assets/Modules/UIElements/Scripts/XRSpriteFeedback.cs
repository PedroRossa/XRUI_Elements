...
public class XRSpriteFeedback : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        elementCollider = elementSprite.GetComponent<Collider>();

        originalColor = elementSprite.color;
        originalScale = elementSprite.transform.localScale;
    ...
    private void SetFeedback(Color color, float scaleMultiplier)
    {
        ...
        elementSprite.transform.localScale = originalScale * scaleMultiplier;
    }
